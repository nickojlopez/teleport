...
func TestIntegrationCRUD(t *testing.T) {
	...
	integrationRunning := "INTEGRATION_STATUS_RUNNING"
	integrationPaused := "INTEGRATION_STATUS_PAUSED"
	...
	integrationResp := ui.IntegrationWithStatus{}
	require.NoError(t, json.Unmarshal(respBody, &integrationResp))

	require.Equal(t, ui.IntegrationWithStatus{
		Integration: ui.Integration{
			Name:    "MyAWSAccount",
			SubKind: types.IntegrationSubKindAWSOIDC,
			AWSOIDC: ui.IntegrationAWSOIDCSpec{
