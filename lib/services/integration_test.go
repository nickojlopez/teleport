...
func TestIntegrationUnmarshal(t *testing.T) {
	...
	storedBlob := []byte(`{"kind":"integration","sub_kind":"aws-oidc","version":"v1","metadata":{"name":"some-integration"},"spec":{"Status":1, "SubKindSpec":{"aws_oidc":{"role_arn":"arn:aws:iam::123456789012:role/DevTeams"}}}}`)
...
func TestDefaultJSONMarshalCycle(t *testing.T) {
	ig, err := types.NewIntegrationAWSOIDC(
		types.Metadata{Name: "some-integration"},
		&types.AWSOIDCIntegrationSpecV1{
			RoleARN: "arn:aws:iam::123456789012:role/DevTeams",
